...
namespace Allure_Report
{
    public class Allure
    {
        ...
        {
            string path = @"C:\Users\aadil\source\repos\Allure_HotelAdactinWebsite\Allure_HotelAdactinWebsite\TestExecutionReport" + "TestExecLog_" + DateTime.Now.ToString("yyyyMMddHHmmss");
